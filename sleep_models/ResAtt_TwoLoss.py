...
class Stage_Net_E2E(nn.Module):
    def __init__(self, input_channels = 5, frame_len = 3750):
        ...
        self.criterion2 = nn.CrossEntropyLoss(weight = torch.FloatTensor([166722/166722, 166722/20433, 166722/237319, 166722/74527, 166722/81947, 0]))#SHHS1 valid
        # self.criterion2 = nn.CrossEntropyLoss(weight = torch.FloatTensor([0.30, 2.45, 0.21, 0.67, 0.61, 0]))   # Literature: SleepFCN
        # self.criterion2 = nn.CrossEntropyLoss(weight = torch.FloatTensor([1, 1.5, 1, 1, 1, 0]))   # Literature: TinySleepNet
    ...
    def forward(self, x, target):
        ...
        x2 = pred_seq.clone().detach()                      # [bs*5, 512, 1]
