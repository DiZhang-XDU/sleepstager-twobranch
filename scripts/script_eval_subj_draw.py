...
if __name__ == "__main__":
    ...
    cfg.add('redir_root',[r"F:/data/filtered_data_125/subjects", r"F:/data/filtered_data_125/subjects"])
    cfg.add('redir_cache',False)
    cfg.add('BATCH_SIZE',150)
    cfg.add('eval_thread',6)
    cfg.add('tvt','test')
    cfg.add('freq',125)
    # cfg.add('best_ckp',r'../../CNN-Stage/.paperwork3/_test_per_subj/shhs1_no/weights_server/epoch_21_val_loss=0.310080_acc=0.8915')
    cfg.add('best_ckp',r'weights_server\checkpoint')
    savePath = 'subjs_shhs1_noRebalancing.csv'
